            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-9">
                    ...
                    <div class="article__actions article__actions--details">
                        ...
                        <button class="article__favorites <?= isset($movies['is_favorit']) ? 'active' : '' ?>" type="button" onclick="addFavoriteMovies(this)" data-fav="<?= isset($movies['is_favorit']) ? '1' : '0' ?>" data-eid="<?= str_encrypt($movies['video_id']) ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            </svg> <span id="label-favorite"><?= isset($movies['is_favorit']) ? 'Hapus dari favorit' : 'Tambah ke favorit' ?></span>
                        </button>
                    </div>
                            ...
                            <?php foreach ($terbaru as $row) : ?>
                                <div class="col-6 col-sm-4 col-md-3 col-xl-6">
                                    <div class="card">
                                        ...
                                        <button class="card__add <?= isset($row['is_favorit']) ? 'active' : '' ?> skeleton_removed" type="button" onclick="addFavorite(this)" data-fav="<?= isset($row['is_favorit']) ? '1' : '0' ?>" data-eid="<?= str_encrypt($row['video_id']) ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<script>
    ...
    function addFavoriteMovies(t) {
        ...
        $.post('<?= base_url('utils/add_favorit') ?>', {
            ...
            if (result.status > 0) {
                fav == 0 ? $(t).attr('data-fav', '1') : $(t).attr('data-fav', '0');
                fav == 0 ? $(t).addClass('active') : $(t).removeClass('active');
                fav == 0 ? $('#label-favorite').text('Hapus dari favorit') : $('#label-favorite').text('Tambah ke favorit');
