    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-6">
                <h1 class="section__title section__title--head" id="genre-title" data-genre="<?= $genre['video_genre_id']; ?>"><?= $genre['video_genre_nama'] ?></h1>
            </div>

            <div class="col-12 col-xl-6">
                <ul class="breadcrumb">
                    <li class="breadcrumb__item"><a href="<?= base_url(); ?>">Home</a></li>
                    <li class="breadcrumb__item">Genre</li>
                    <li class="breadcrumb__item breadcrumb__item--active"><?= $genre['video_genre_nama'] ?></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="section__title">Film Terbaik</h2>
            </div>
            <div class="col-12">
...
<script>
    ...
    function skeleton_loader() {
        ...
        $.post('<?= base_url('utils/get_list_movies'); ?>', {
            ...
            'video_genre': $('#genre-title').data('genre'),
    ...
    function get_pagination() {
        ...
        $.post('<?= base_url('utils/get_count_data') ?>', {
            'country_id': vnid,
            'video_tahun': tahun,
            'video_genre_id': $('#genre-title').data('genre')
        }, function(result, textStatus, xhr) {
