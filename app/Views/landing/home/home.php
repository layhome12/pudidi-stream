    ...
    <div class="home__carousel owl-carousel" id="flixtv-hero">
        <?php foreach ($slider as $row) : ?>
            <div class="home__card">
                <a href="<?= base_url('movie/' . seo_url_encode($row['video_nama'], $row['video_id'])); ?>">
                ...
                <button class="home__add <?= isset($row['is_favorit']) ? 'active' : '' ?>" type="button" onclick="addFavorite(this)" data-fav="<?= isset($row['is_favorit']) ? '1' : '0' ?>" data-eid="<?= str_encrypt($row['video_id']) ?>">
                    ...
                    <div class="section__carousel owl-carousel" id="subscriptions">
                        <?php foreach ($rekomendasi as $row) : ?>
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="<?= base_url('movie/' . seo_url_encode($row['video_nama'], $row['video_id'])); ?>"><?= $row['video_nama'] ?></a></h3>
