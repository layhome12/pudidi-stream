...
<div class="row row--grid">
    <?php foreach ($user_favorite as $row) : ?>
        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
            <div class="card card--favorites">
                ...
                <button class="card__add skeleton_removed active" type="button" onclick="addFavorite(this)" data-fav="1" data-eid="<?= str_encrypt($row['video_id']) ?>">
