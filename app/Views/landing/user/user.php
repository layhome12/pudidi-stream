                ...
                <div class="profile">
                    ...
                    <ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
                        ...
                        <?php if (session()->get('user_level_id') == 1) : ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('administrator'); ?>">Control Panel</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                    <!-- end tabs nav -->
                                ...
                                <table class="main__table main__table--dash">
                                    ...
                                    <tbody>
                                        <?php foreach ($list_untukmu as $row) : ?>
                                            <tr>
                                                <td>
                                                    <div class="main__table-text"><a href="<?= base_url('movies/' . seo_url_encode($row['video_nama'], $row['video_id'])); ?>"><?= $row['video_nama']; ?></a></div>
                                                </td>
                                                <td>
