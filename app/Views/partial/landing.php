                ...
                <div class="col-12">
                    <div class="header__content">
                        ...
                        <a href="<?= base_url(); ?>" class="header__logo">
                            <img src="<?= base_url() ?>/public/public_assets/img/logo.svg" alt="Movies & TV Shows, Online cinema HTML Template">
                        </a>
                            ...
                            <li class="header__nav-item">
                                ...
                                <ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu2">
                                    <?php foreach ($LD->getKategori() as $row) : ?>
                                        <li>
                                            <a href="<?= base_url('/kategori/' . $row['video_kategori_seo']) ?>"><?= $row['video_kategori_nama']; ?></a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </li>
                        ...
                        <div class="header__actions">
                            <form action="<?= base_url('pencarian') ?>" class="header__form" method="GET">
                                <input class="header__form-input" type="text" name="keyword" placeholder="Cari..">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer__content">
                        <small class="footer__copyright">© FlixTV.template, 2021. Created by <a href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Layhome12</a>.</small>
                    </div>
                </div>
            </div>
        </div>
