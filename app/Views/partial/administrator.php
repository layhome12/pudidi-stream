                        ...
                        <div class="serach_field-area d-flex align-items-center">
                            <div class="search_inner">
                                <form action="#">
                                    ...
                                    <button type="submit">
                                        <img src="<?= base_url() ?>/public/admin_assets/img/icon/icon_search.svg" alt="" />
                                    </button>
                                </form>
                            </div>
                            ...
                            <div class="header_notification_warp d-flex align-items-center">
                                <li>
                                    <a class="bell_notification_clicker nav-link-notify" href="#">
                                        <img src="<?= base_url() ?>/public/admin_assets/img/icon/bell.svg" alt="" />
                                    </a>
                                        ...
                                        <div class="Notification_body">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img src="<?= base_url() ?>/public/admin_assets/img/staf/2.png" alt="" /></a>
                                                </div>
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img src="<?= base_url() ?>/public/admin_assets/img/staf/4.png" alt="" /></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img src="<?= base_url() ?>/public/admin_assets/img/staf/3.png" alt="" /></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                ...
                                <li>
                                    <a class="CHATBOX_open nav-link-notify" href="#">
                                        <img src="<?= base_url() ?>/public/admin_assets/img/icon/msg.svg" alt="" />
                                    </a>
                                </li>
                            </div>
                    ...
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="<?= base_url() ?>/public/admin_assets/img/staf/1.png" alt="" />
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="<?= base_url() ?>/public/admin_assets/img/staf/2.png" alt="" />
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="<?= base_url() ?>/public/admin_assets/img/staf/3.png" alt="" />
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="<?= base_url() ?>/public/admin_assets/img/staf/4.png" alt="" />
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="<?= base_url() ?>/public/admin_assets/img/staf/5.png" alt="" />
                            </div>
                        </a>
                    </li>
                    <li>
