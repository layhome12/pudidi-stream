        ...
        <div class="sign__wrap">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8">
                    <form method="POST" action="<?= base_user('/profile/setting_save'); ?>" id="form-data" class="sign__form d-block sign__form--profile sign__form--first" enctype="multipart/form-data" onsubmit="return false">
            ...
            $.ajax({
                ...
                success: function(result, textStatus, xhr) {
                    ...
                    if (result.status > 0) {
                        ...
                        setTimeout(function() {
                            window.location.replace('<?= base_user('/profile') ?>');
                        }, 1000);
                    } else {
